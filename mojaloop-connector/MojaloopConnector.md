...
Payment Manager an open sourced* tool is an example of this. Payment manager provides additional benefits to this, more information can be found [here](../payment-manager/PaymentManager.md). Payment Manager deployments can be either Saas or self hosted.
